...
struct ClientRequestSdo {
    ...
    bool valid() const { return client_subcommand == 0 && ccs == sdo_cs_codes::client_block_write; }
};
...
struct ClientSegmentSdo {
    ...
    bool valid() const { return sequence_counter >= 1 && sequence_counter <= 127; }
};
...
struct ClientEndSdo {
    ...
    bool valid() const { return client_subcommand == 1 && ccs == sdo_cs_codes::client_block_write; }
};
...
struct ServerEndResponseSdo {
    ...
    bool valid() const { return server_subcommand == 1 && scs == sdo_cs_codes::server_block_write; }
};
